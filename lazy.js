...
function Lazy(em, opts) {
    ...
    self.__defineGetter__('lines', function () {
        return self.bucket([], function (chunkArray, chunk) {
            var newline = '\n'.charCodeAt(0), chunkStartIndex = 0;
            ...
            if (chunk){
                ...
                for (i = 0; i < chunk.length; i++) {
                    if (chunk[i] === newline) {
                        ...
                        if (i > 0) {
                            chunkArray.push(chunk.slice(chunkStartIndex, i));
                        }
            ...
            if (chunkStartIndex > 0) {
                ...
                if (chunkStartIndex < chunk.length) {
                    chunkArray.push(chunk.slice(chunkStartIndex));
                }
            } else {
